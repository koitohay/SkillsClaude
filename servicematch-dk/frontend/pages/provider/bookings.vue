<template>
  <div class="max-w-3xl mx-auto">
    <div class="mb-8">
      ...
      <p class="page-sub">Accepterede tilbud fra klienter</p>
    </div>
    ...
    <div v-else-if="!bookings.length" class="card text-center py-16">
      ...
      <p class="text-sm" style="color: var(--text-2);">Når en klient accepterer dit tilbud, vises det her.</p>
    </div>
      ...
      <div v-for="booking in bookings" :key="booking.id"
        ...
        <div class="flex items-start justify-between gap-4">
          <div class="flex-1 min-w-0">
            ...
            <p v-if="booking.freeTextDescription" class="text-sm mb-2 leading-snug" style="color: var(--text-2);">
          ...
          <div class="text-right flex-shrink-0">
            <div v-if="myAcceptedPrice(booking)" class="mb-3">
              <p class="text-xs mb-0.5" style="color: var(--text-3);">Dit tilbud</p>
              <p class="text-xl font-bold leading-none" style="color: #059669; letter-spacing: -0.03em;">
                {{ myAcceptedPrice(booking) }}<span class="text-sm font-normal ml-0.5" style="color: var(--text-3);">DKK</span>
              </p>
            </div>
